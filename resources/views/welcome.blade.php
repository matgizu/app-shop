...
<div class="header header-filter" style="background-image: url('https://images.unsplash.com/photo-1423655156442-ccc11daa4e99?crop=entropy&dpr=2&fit=crop&fm=jpg&h=750&ixjsv=2.1.0&ixlib=rb-0.3.5&q=50&w=1450');">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <h1 class="title">SOMOS DESARROLLADORES!</h1>
                <h4>Somos una empresa dedicada al desarrollo web es por ello que te ofrecemos todo lo que una página web solicita tales como Desarrollo desde 0, administracion de tu sitio y soporte 24/7</h4>
                <br />
                   ...
                   @foreach ($products as $product)
                    <div class="col-md-4">
                        <div class="team-player">
                            ...
                            @else
                                <img src="URL DE UNA IMAGEN POR DEFECTO" class="img-raised img-circle">
                            @endif
